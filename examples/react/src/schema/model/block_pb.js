...
proto.model.GetBlocksResponse = function(opt_data) {
  jspb.Message.initialize(
    ...
    0,
    -1,
    proto.model.GetBlocksResponse.repeatedFields_,
    null,
  );
};
    ...
    var f,
      obj = {
        ...
        transactionsList: jspb.Message.toObjectList(
          ...
          model_transaction_pb.Transaction.toObject,
          includeInstance,
        ),
...
proto.model.Block.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(5, f, model_transaction_pb.Transaction.serializeBinaryToWriter);
  }
...
proto.model.Block.prototype.getTransactionsList = function() {
  return /** @type{!Array<!proto.model.Transaction>} */ (jspb.Message.getRepeatedWrapperField(
    this,
...
proto.model.Block.prototype.getGenerator_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getGenerator()));
};
...
proto.model.Block.prototype.getGenerator_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getGenerator()));
};
...
proto.model.GetBlocksResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, proto.model.Block.serializeBinaryToWriter);
  }
};
...
proto.model.GetBlocksResponse.prototype.getBlocksList = function() {
  return /** @type{!Array<!proto.model.Block>} */ (jspb.Message.getRepeatedWrapperField(
    this,
    proto.model.Block,
    3,
  ));
