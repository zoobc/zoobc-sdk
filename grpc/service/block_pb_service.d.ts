...
type BlockServiceGetBlock = {
  ...
  readonly responseType: typeof model_block_pb.GetBlockResponse;
};
...
export class BlockServiceClient {
  ...
  getBlock(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: model_block_pb.GetBlockResponse|null) => void
  ): UnaryResponse;
  getBlock(
    requestMessage: model_block_pb.GetBlockRequest,
    callback: (error: ServiceError|null, responseMessage: model_block_pb.GetBlockResponse|null) => void
