...
type TransactionServiceGetTransactionMinimumFee = {
  readonly methodName: string;
  readonly service: typeof TransactionService;
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof model_transaction_pb.GetTransactionMinimumFeeRequest;
  readonly responseType: typeof model_transaction_pb.GetTransactionMinimumFeeResponse;
};
...
export class TransactionService {
  ...
  static readonly GetTransactionMinimumFee: TransactionServiceGetTransactionMinimumFee;
}
...
export class TransactionServiceClient {
  ...
  getTransactionMinimumFee(
    requestMessage: model_transaction_pb.GetTransactionMinimumFeeRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: model_transaction_pb.GetTransactionMinimumFeeResponse|null) => void
  ): UnaryResponse;
  getTransactionMinimumFee(
    requestMessage: model_transaction_pb.GetTransactionMinimumFeeRequest,
    callback: (error: ServiceError|null, responseMessage: model_transaction_pb.GetTransactionMinimumFeeResponse|null) => void
