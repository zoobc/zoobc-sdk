...
export class Block extends jspb.Message {
  ...
  clearSpinepublickeysList(): void;
  getSpinepublickeysList(): Array<model_spine_pb.SpinePublicKey>;
  setSpinepublickeysList(value: Array<model_spine_pb.SpinePublicKey>): void;
  addSpinepublickeys(value?: model_spine_pb.SpinePublicKey, index?: number): model_spine_pb.SpinePublicKey;

  clearSpineblockmanifestsList(): void;
  getSpineblockmanifestsList(): Array<model_spineBlockManifest_pb.SpineBlockManifest>;
  setSpineblockmanifestsList(value: Array<model_spineBlockManifest_pb.SpineBlockManifest>): void;
  addSpineblockmanifests(value?: model_spineBlockManifest_pb.SpineBlockManifest, index?: number): model_spineBlockManifest_pb.SpineBlockManifest;
...
export namespace Block {
  export type AsObject = {
    ...
    spineblockmanifestsList: Array<model_spineBlockManifest_pb.SpineBlockManifest.AsObject>,
