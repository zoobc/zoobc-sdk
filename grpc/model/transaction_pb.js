...
goog.exportSymbol('proto.model.SendZBCTransactionBody', null, global);
 ...
 * @constructor
 */
proto.model.SendZBCTransactionBody = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.model.SendZBCTransactionBody, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.model.SendZBCTransactionBody.displayName = 'proto.model.SendZBCTransactionBody';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.model.Transaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sendzbctransactionbody: (f = msg.getSendzbctransactionbody()) && proto.model.SendZBCTransactionBody.toObject(includeInstance, f),
...
proto.model.Transaction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 17:
      ...
      break;
    case 18:
      var value = new proto.model.SendZBCTransactionBody;
      reader.readMessage(value,proto.model.SendZBCTransactionBody.deserializeBinaryFromReader);
      msg.setSendzbctransactionbody(value);
      break;
    case 19:
...
proto.model.Transaction.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSendzbctransactionbody();
  if (f != null) {
    writer.writeMessage(
      18,
      f,
      proto.model.SendZBCTransactionBody.serializeBinaryToWriter
    );
  }
...
/**
 * optional SendZBCTransactionBody sendZBCTransactionBody = 18;
 * @return {?proto.model.SendZBCTransactionBody}
 */
proto.model.Transaction.prototype.getSendzbctransactionbody = function() {
  return /** @type{?proto.model.SendZBCTransactionBody} */ (
    jspb.Message.getWrapperField(this, proto.model.SendZBCTransactionBody, 18));
};


/** @param {?proto.model.SendZBCTransactionBody|undefined} value */
proto.model.Transaction.prototype.setSendzbctransactionbody = function(value) {
 ...
 * Clears the message field making it undefined.
 */
proto.model.Transaction.prototype.clearSendzbctransactionbody = function() {
  this.setSendzbctransactionbody(undefined);
};
 ...
 * @return {boolean}
 */
proto.model.Transaction.prototype.hasSendzbctransactionbody = function() {
 ...
 * @return {!Object}
 */
proto.model.SendZBCTransactionBody.prototype.toObject = function(opt_includeInstance) {
  return proto.model.SendZBCTransactionBody.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.model.SendZBCTransactionBody} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.SendZBCTransactionBody.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.model.SendZBCTransactionBody}
 */
proto.model.SendZBCTransactionBody.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.model.SendZBCTransactionBody;
  return proto.model.SendZBCTransactionBody.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.model.SendZBCTransactionBody} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.model.SendZBCTransactionBody}
 */
proto.model.SendZBCTransactionBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.model.SendZBCTransactionBody.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.model.SendZBCTransactionBody.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.model.SendZBCTransactionBody} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.model.SendZBCTransactionBody.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAmount();
  if (parseInt(f, 10) !== 0) {
    writer.writeInt64String(
 ...
 * @return {string}
 */
proto.model.SendZBCTransactionBody.prototype.getAmount = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, "0"));
};


/** @param {string} value */
proto.model.SendZBCTransactionBody.prototype.setAmount = function(value) {
