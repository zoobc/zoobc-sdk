...
const commonjsPulgin = () => {
	return commonjs({
		...
		namedExports: {
			...
			"./grpc/model/nodeRegistration_pb": [
			...
			"./grpc/model/liquidPayment_pb.js": [
				"GetLiquidTransactionsResponse",
				"GetLiquidTransactionsRequest",
			],
		},
	});
};
