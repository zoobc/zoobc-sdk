...
export { getZBCAddress, isZBCAddressValid, ZBCAddressToBytes, readInt64, writeInt32 } from './helper/utils';
...
declare const zoobc: {
  Transactions: {
    sendMoney: (
      data: import('./helper/transaction-builder/send-money').SendMoneyInterface,
      seed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    get: (id: string) => Promise<import('../grpc/model/transaction_pb').Transaction.AsObject>;
    getList: (
      params?: import('./Transactions').TransactionListParams | undefined,
    ) => Promise<import('../grpc/model/transaction_pb').GetTransactionsResponse.AsObject>;
  };
  Network: {
  ...
  Node: {
    register: (
      data: import('./helper/transaction-builder/register-node').RegisterNodeInterface,
      childSeed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    update: (
      data: import('./helper/transaction-builder/update-node').UpdateNodeInterface,
      childSeed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    remove: (
      data: import('./helper/transaction-builder/remove-node').RemoveNodeInterface,
      childSeed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    claim: (
      data: import('./helper/transaction-builder/claim-node').ClaimNodeInterface,
      childSeed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    getHardwareInfo: (
      networkIP: string,
      childSeed: import('bip32').BIP32Interface,
    ) => import('rxjs').Observable<import('../grpc/model/nodeHardware_pb').GetNodeHardwareResponse.AsObject>;
    generateNodeKey: (
      networkIP: string,
      childSeed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/node_pb').GenerateNodeKeyResponse.AsObject>;
    getList: (
      params?: import('./Node').NodeListParams | undefined,
    ) => Promise<import('../grpc/model/nodeRegistration_pb').GetNodeRegistrationsResponse.AsObject>;
    get: (params: import('./Node').NodeParams) => Promise<import('../grpc/model/nodeRegistration_pb').GetNodeRegistrationResponse.AsObject>;
    getPending: (
      limit: number,
      childSeed: import('bip32').BIP32Interface,
    ) => import('rxjs').Observable<import('../grpc/model/nodeRegistration_pb').GetPendingNodeRegistrationsResponse.AsObject>;
  };
  Poown: {
  ...
  Escrows: {
    approval: (
      data: import('./helper/transaction-builder/escrow-transaction').EscrowApprovalInterface,
      seed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    get: (id: string) => Promise<import('../grpc/model/escrow_pb').Escrow.AsObject>;
    getList: (
      params?: import('./Escrows').EscrowListParams | undefined,
    ) => Promise<import('../grpc/model/escrow_pb').GetEscrowTransactionsResponse.AsObject>;
  };
  Mempool: {
    get: (id: string) => Promise<import('../grpc/model/mempool_pb').MempoolTransaction.AsObject>;
    getList: (
      params?: import('./Mempool').MempoolListParams | undefined,
    ) => Promise<import('../grpc/model/mempool_pb').GetMempoolTransactionsResponse.AsObject>;
  };
  Block: {
  ...
  MultiSignature: {
    getPendingByTxHash: (
      txHash: string,
    ) => Promise<import('../grpc/model/multiSignature_pb').GetPendingTransactionDetailByTransactionHashResponse.AsObject>;
    getPendingList: (
      params: import('./MultiSignature').MultisigPendingListParams,
    ) => Promise<import('../grpc/model/multiSignature_pb').GetPendingTransactionsResponse.AsObject>;
    ...
    getMultisigInfo: (
      params: import('./MultiSignature').MultisigInfoParams,
    ) => Promise<import('../grpc/model/multiSignature_pb').GetMultisignatureInfoResponse.AsObject>;
    postTransaction: (
      data: import('./helper/transaction-builder/multisignature').MultiSigInterface,
      childSeed: import('bip32').BIP32Interface,
    ) => Promise<import('../grpc/model/transaction_pb').PostTransactionResponse.AsObject>;
    getMultisigAddress: (
      participantsAddress: string,
    ) => Promise<import('../grpc/model/multiSignature_pb').GetMultisigAddressByParticipantAddressResponse.AsObject>;
  };
  AccountDataset: {
  ...
  ParticipationScore: {
    ...
    getHistory: (
      fromHeight: number,
      toHeight: number,
    ) => Promise<import('../grpc/model/participationScore_pb').GetParticipationScoresResponse.AsObject>;
  };
};
