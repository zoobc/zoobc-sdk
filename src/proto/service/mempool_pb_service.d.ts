...
type MempoolServiceGetMempoolTransaction = {
  ...
  readonly responseType: typeof model_mempool_pb.MempoolTransaction;
};
...
export class MempoolServiceClient {
  ...
  getMempoolTransaction(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: model_mempool_pb.MempoolTransaction|null) => void
  ): UnaryResponse;
  getMempoolTransaction(
    requestMessage: model_mempool_pb.GetMempoolTransactionRequest,
    callback: (error: ServiceError|null, responseMessage: model_mempool_pb.MempoolTransaction|null) => void
