...
type AccountBalanceServiceGetAccountBalance = {
  ...
  readonly responseType: typeof model_accountBalance_pb.AccountBalance;
};
...
export class AccountBalanceServiceClient {
  ...
  getAccountBalance(
    ...
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: model_accountBalance_pb.AccountBalance|null) => void
  ): UnaryResponse;
  getAccountBalance(
    requestMessage: model_accountBalance_pb.GetAccountBalanceRequest,
    callback: (error: ServiceError|null, responseMessage: model_accountBalance_pb.AccountBalance|null) => void
