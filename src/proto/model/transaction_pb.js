...
proto.model.NodeRegistrationTransactionBody.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    nodeaddresslength: jspb.Message.getFieldWithDefault(msg, 5, 0),
    nodeaddress: jspb.Message.getFieldWithDefault(msg, 6, ""),
    lockedbalance: jspb.Message.getFieldWithDefault(msg, 7, 0),
...
proto.model.NodeRegistrationTransactionBody.prototype.getPoown = function() {
  return /** @type{?proto.model.ProofOfOwnership} */ (
    jspb.Message.getWrapperField(this, proto.model.ProofOfOwnership, 8));
};
